...
const orderSchema = new Schema(
  {
    ...
    /** Estado de la entrega: PAID, REVIEWING, MAKING, READY_FOR_DELIVERY, CONFIRMED, DELIVERED, CANCELLED */
    deliveryStatus: {
      type: String,
      enum: ["PAID", "REVIEWING", "MAKING", "READY_FOR_DELIVERY", "CONFIRMED", "DELIVERED", "CANCELLED"],
      default: "PAID",
    },
